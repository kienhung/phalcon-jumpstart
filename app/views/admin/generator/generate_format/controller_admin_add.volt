...
{% block content %}
    ...
    <div class="header-row">
        <div class="header-row-wrapper">
            <header>
                <h1 class="header-main" id="page-header" rel="menu_{{MODULE_LOWER}}_add">
                    <a href="javascript:void(0)" id="menu-toggle" style="color:#333;"><i class="fa {{FA_ICON}}"></i></a>
                    <a href="{{ config.application.baseUriAdmin }}{{MODULE_LOWER}}" style="color:#333;">{{MODULE}}</a> / {{ lang._('AddTitle') }}
                </h1>
            </header>
        </div>
    </div>
    ...
    <form method="post" action="" role="form" enctype="multipart/form-data">
        ...
        <div class="row section buttons">
            <input type="submit" name="fsubmit" value="{{ lang._('AddButton') }}" class="btn btn-success">
